...
<html>
<head>
    <title>Simple PHP/MariaDB Project (<?php echo $_ENV['DOCKER_CONTAINER_NAME'] ?>)</title>
</head>
<body>
    <h1>Simple PHP/MariaDB Project (<?php echo $_ENV['DOCKER_CONTAINER_NAME'] ?>)</h1>
    ...
    <?php
        try {
            $connection = new \PDO('mysql:dbname=docker;host=mariadb', 'docker', 'docker');
